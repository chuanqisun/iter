...
type OfficialModel = "gpt-35-turbo" | "gpt-4" | "gpt-4-32k" | "gpt-4o" | "gpt-4o-mini" | "text-embedding-ada-002";
...
export function isChatModel(deployment: ModelDeployment): boolean {
  return ["gpt-35-turbo", "gpt-35-turbo-16k", "gpt-4", "gpt-4-32k", "gpt-4o", "gpt-4o-mini"].includes(deployment.model);
}
